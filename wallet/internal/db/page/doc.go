...
// # Store integration
//
// Stores implement paginated queries by calling [FetchFirstOrNext], which
// dispatches to a first-page or next-page SQL query depending on whether
// the request carries a cursor, then maps the raw rows to domain items
// via a caller-supplied converter.
package page
